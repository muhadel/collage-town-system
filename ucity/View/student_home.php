...
<div class="row"><button class="button1 col-lg-3"><a style="color:#fff;" href="old_student_request.php">Old Student Request</a></button>
    <button class="button2 col-lg-3"><a style="color:#fff;" href="downloadpdf.php">Check acceptance</a></button>
    <button class="button3 col-lg-3"><a style="color:#fff;" href="show_attendance.php">See Attendance</a></button></div>
              
              
<div class="row"><button class="button4 col-lg-3"><a style="color:#fff;" href="show_penalties1.php">See Penalties</a></button>
    
    <button class="button5 col-lg-3"><a style="color:#fff;" href="show_announcements.php">See Announcement</a></button>
<button class="button6 col-lg-3"><a style="color:#fff;" href="payment.php">Payment</a></button>
