...
if ((isset($_SESSION['username']) && isset($_SESSION['password']) && isset($_SESSION['type']))) {
    ...
    echo '<header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo">U<span class="lite">City</span></a>
            <!--logo end-->
...
?>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
              ...
              <!-- Form validations -->              
              <img src="img/pic2.jpg" width="100%" height="290px;">
              <br><br><br>
              <h1>Instructions</h1>
