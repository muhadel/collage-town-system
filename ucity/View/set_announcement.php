...
if($_POST['btn'])
{
    if(!$_POST['ann'])
    {
        ...
        $msg ="<font color='red'>Please Enter your announcement</font>";
        
        
    }else
    {
        $ann=$db->clean($_POST['ann']);
        $date = date("Y-m-d");
        $admin_object->set_announcement($ann,$date);
        $msg ="<font color='green'>Announcement is added Sucessfully</font>";
    }
}
				...
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
                                                <li><i class="f"></i><a href="admin_home.php">Admin</a></li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="set_announcement.php">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Announcement<span class="required">*</span></label>
                                          <div class="col-lg-10" style="height: 300px;">
                                              
                                              <textarea  wrap="on" style="outline: none;resize: none;border-style: inset;" rows="15" cols="100" name="ann" value=""></textarea>
                                          </div>
                                      </div>
